...
public class ColorUtils {
    ...
    public String getColorNameFromRgb(int r, int g, int b) {
    	System.out.println("colorhex"+Integer.toHexString(r)+Integer.toHexString(g)+Integer.toHexString(b));
    ...
    public String gethexfromcolor(String name){
    	ArrayList<ColorName> colorList = initColorList();
    	String hex = "";
    	for (ColorName c : colorList) {
    		if(c.getName().equals(name)){
    			
    			hex = Integer.toHexString(c.getR()) + Integer.toHexString(c.getG()) + Integer.toHexString(c.getB());
    		}
    	}
    	return hex;
