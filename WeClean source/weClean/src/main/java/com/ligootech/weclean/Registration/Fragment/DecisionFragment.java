...
public class DecisionFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return initializeUI(inflater.inflate(R.layout.fragment_decision, container, false));
    }
    ...
    public View initializeUI(View v){
        ...
        loginButton.setOnClickListener((RegistrationActivity) getActivity());
        registerButton.setOnClickListener((RegistrationActivity) getActivity());
